# Practice 3: Transport and architecture
Design the transport network that connects the access layer to the core for a dispersed set of sites.

## Expected student tasks

- Select a transport topology.
